...
export default function KBlogsPostPage() {
  const params = useParams();
  const { subCategory, board, postId } = params as {
    subCategory: string;
    board: string;
    postId: string;
  };
  ...
  const breadcrumbItems = [
    { label: "Home", href: "/" },
    { label: "K-Blogs", href: "/k-blogs" },
    { label: subCategory, href: `/k-blogs/${subCategory}` },
    { label: board, href: `/k-blogs/${subCategory}/${board}` },
    ...
    try {
      ...
      await runTransaction(db, async (transaction) => {
        ...
        transaction.set(newCommentRef, {
          boardPath: `k-blogs/${subCategory}/${board}`,
          postId: postId,
          content: newComment,
          authorId: user.uid,
